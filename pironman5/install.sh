...
RUN "[ -x /opt/pironman5/venv/bin/register-python-argcomplete ] && /opt/pironman5/venv/bin/register-python-argcomplete pironman5 > /etc/bash_completion.d/pironman5 || true" "Register bash completion"
